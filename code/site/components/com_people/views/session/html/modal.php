...
<popup>    
    <popup:header>
    <?php print JText::_('LOGIN') ?>
    </popup:header>
    <popup:body>
        <div class="user">
    		<form action="<?=@route()?>" method="post" id="modal-login-form">    			
    ...
    <popup:footer>
        <input type="submit" data-trigger="Submit" data-submit-form="#modal-login-form" name="Submit" class="btn btn-primary" value="<?php print JText::_('LOGIN') ?>" />    
    </popup:footer>
</popup>
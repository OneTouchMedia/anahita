...
<form data-behavior="FormValidator" action="<?= @route('view=person') ?>" method="post" name="userform" id="userform" autocomplete="off">
	...
	<div class="control-group">
	    ...
	    <div class="controls">
	    	<div class="input-prepend">
	    		<span class="add-on"><i class="icon-user"></i></span>
	    		<input data-validators="required validate-remote url:'<?=@route('view=person')?>'" type="text" id="username" name="username" value="" maxlength="25" />
	    	</div>
	    </div>
	</div>
	...
	<div class="control-group">
	    ...
	    <div class="controls">
	    	<div class="input-prepend">
	    		...
	    		<input data-validators="required validate-email validate-remote url:'<?=@route('view=person')?>'" type="text" id="email" name="email" value="" maxlength="100" />
	    	</div>
	    </div>
	</div>

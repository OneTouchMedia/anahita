...
<form data-behavior="FormValidator" action="<?= @route('view=person') ?>" method="post" name="userform" id="userform" autocomplete="off">
	...
	<div class="control-group">
	    ...
	    <div class="controls">
	    	<div class="input-prepend">
	    		<span class="add-on"><i class="icon-user"></i></span>
	    		<input data-validators="required validate-remote url:'<?=@route('view=person')?>'" type="text" id="username" name="username" value="d<?=uniqid()?>" maxlength="25" />
	    	</div>
	    </div>
	</div>
	...
	<div class="control-group">
	    ...
	    <div class="controls">
	    	<div class="input-prepend">
	    		...
	    		<input data-validators="required validate-email validate-remote url:'<?=@route('view=person')?>'" type="text" id="email" name="email" value="d<?=uniqid()?>@example.com" maxlength="100" />
	    	</div>
	    </div>
	</div>
	...
	<div class="control-group">
	   <label class="control-label"  for="password2">
			<?php print JText::_('COM-PEOPLE-PASSWORD-VERIFY'); ?>:
	   </label>
	   <div class="controls">
	   		<div class="input-prepend">

...
?>
<form  data-behavior="Request" data-request-options="{url:'<?=$search_action?>',update:'<?= $update_container ?>'}" id="an-search-form" class="form-search" name="an-search-form"  method="GET">				

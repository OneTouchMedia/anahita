...
function anahita_24()
{
	...
	dbexec("DELETE FROM jos_modules WHERE module IN ('mod_feed', 'mod_login', 'mod_breadcrumbs', 'mod_sections', 'mod_syndicate', 'mod_latestnews', 'mod_newsflash', 'mod_related_items')");	
}
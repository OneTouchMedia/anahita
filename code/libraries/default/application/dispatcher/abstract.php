 ...
 * @link       http://www.anahitapolis.com
 */
abstract class LibApplicationDispatcherAbstract extends KControllerAbstract implements KServiceInstantiatable
{    
    /** 
     * Constructor.
     *
    ...
    protected function _actionRoute(KCommandContext $context)
    {
        ...
        //hardcode tmpl to offline
        if ( $this->_application->getCfg('offline') ) {
            $this->_request->tmpl = 'offline';           
        }
    }
